...
import com.pixlite.naturalproof.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun capturePhoto() {
        ...
        val sessionDir = File(getExternalFilesDir(null), "PixLiteNaturalProof/${sessionStamp()}")
            .apply { mkdirs() }
    ...
    companion object {
        private const val TAG = "NaturalProof"
    }
}

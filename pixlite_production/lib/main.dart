  ...
  Widget home(){
    ...
    return ListView(padding:const EdgeInsets.fromLTRB(16,10,16,22),children:[
      ...
      Container(padding:const EdgeInsets.all(18),decoration:BoxDecoration(borderRadius:BorderRadius.circular(26),border:Border.all(color:const Color(0x667C4DFF)),gradient:const LinearGradient(colors:[Color(0xFF181044),Color(0xFF2B1674),Color(0xFF053D72)],begin:Alignment.topLeft,end:Alignment.bottomRight),boxShadow:const [BoxShadow(color:Color(0x553E2BFF),blurRadius:30,offset:Offset(0,12))]),child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
        Row(children:[Container(width:58,height:58,decoration:BoxDecoration(borderRadius:BorderRadius.circular(18),gradient:const LinearGradient(colors:[Color(0xFFBC2FFF),Color(0xFF2A6BFF)])),child:const Icon(Icons.document_scanner_rounded,color:Colors.white,size:31)),const SizedBox(width:14),const Expanded(child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[Text('Scan Anything.',style:TextStyle(color:Colors.white,fontSize:24,fontWeight:FontWeight.w900,height:1)),SizedBox(height:4),Text('Save Everything.',style:TextStyle(color:Colors.white,fontSize:24,fontWeight:FontWeight.w900,height:1)),SizedBox(height:8),Text('Fast • Clear • Secure',style:TextStyle(color:Color(0xFFD5DAFF),fontSize:11.5))]))]),
        const SizedBox(height:18),
        Container(decoration:BoxDecoration(gradient:const LinearGradient(colors:[Color(0xFFC72EF3),Color(0xFF6D35FF),Color(0xFF009CF6)]),borderRadius:BorderRadius.circular(16),boxShadow:const [BoxShadow(color:Color(0x553C7CFF),blurRadius:18)]),child:FilledButton.icon(onPressed:()=>open(ScanScreen(tr:tr)),style:FilledButton.styleFrom(backgroundColor:Colors.transparent,shadowColor:Colors.transparent,minimumSize:const Size.fromHeight(56)),icon:const Icon(Icons.photo_camera_rounded),label:const Text('Scan / Import Document',style:TextStyle(fontWeight:FontWeight.w900)))),
        const SizedBox(height:10),OutlinedButton.icon(onPressed:()=>open(ScanScreen(tr:tr)),icon:const Icon(Icons.picture_as_pdf_rounded),label:const Text('Scan as PDF',style:TextStyle(fontWeight:FontWeight.w800)))
      ])),

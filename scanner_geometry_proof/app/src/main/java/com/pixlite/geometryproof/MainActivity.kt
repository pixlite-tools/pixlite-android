...
import com.pixlite.geometryproof.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun capturePhoto() {
        ...
        val sessionDir = File(getExternalFilesDir(null), "PixLiteGeometryProof/${sessionStamp()}")
            .apply { mkdirs() }
    ...
    companion object {
        private const val TAG = "GeometryProof"
    }
}
